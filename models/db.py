...
def __photo(value):
    '''
    Función que permite devuelve una foto de usuario
    '''
    if not value:
...
db.define_table('website',
    ...
    Field('paginate', 'integer', default=20, label=T('Pagination'), comment=T("It was used in resources, users and news searched")),
