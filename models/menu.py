...
def _():
    ...
    if(auth.has_membership("Administrador")):
        response.menu += [(T("Administration"),False, URL("default", "dashboard"), [
            ("user", False, A(CAT(XML('<ico class="glyphicon glyphicon-user"></ico> '), T("Users")), _href=URL("admin", "user"), **{"_data-target": "#user"})),
            ...
            ("admin_category", False, A(CAT(XML('<ico class="glyphicon glyphicon-tags"></ico> '), T("Categories")), _href=URL("resource", "admin_category"), **{"_data-target": "#admin_category"})),
            ...
            ("rtype", False, A(CAT(XML('<ico class="glyphicon glyphicon-tag"></ico> '), T("Types")), _href=URL("resource", "admin_table", args=["rtype"]), **{"_data-target": "#rtype"})),
